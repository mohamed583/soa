...
/**
 * <p>Classe Java pour showDepartmentResponse complex type.</p>
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="showDepartmentResponse">
 *   <complexContent>
...
@XmlType(name = "showDepartmentResponse", propOrder = {
    "_return"
})
public class ShowDepartmentResponse {
