...
/**
 * <p>Classe Java pour ListDemandesCongesResponse complex type.</p>
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="ListDemandesCongesResponse">
 *   <complexContent>
...
@XmlType(name = "ListDemandesCongesResponse", propOrder = {
    "_return"
})
public class ListDemandesCongesResponse {
