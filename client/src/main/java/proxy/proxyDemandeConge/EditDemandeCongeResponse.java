...
/**
 * <p>Classe Java pour EditDemandeCongeResponse complex type.</p>
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="EditDemandeCongeResponse">
 *   <complexContent>
...
@XmlType(name = "EditDemandeCongeResponse", propOrder = {
    "_return"
})
public class EditDemandeCongeResponse {
