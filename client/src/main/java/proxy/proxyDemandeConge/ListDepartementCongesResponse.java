...
/**
 * <p>Classe Java pour ListDepartementCongesResponse complex type.</p>
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="ListDepartementCongesResponse">
 *   <complexContent>
...
@XmlType(name = "ListDepartementCongesResponse", propOrder = {
    "_return"
})
public class ListDepartementCongesResponse {

    @XmlElement(name = "return")
    protected List<DemandeConge_Type> _return;
     ...
     */
    public List<DemandeConge_Type> getReturn() {
        if (_return == null) {
